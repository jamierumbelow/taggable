 ...
 *
 * Modified lots by Jamie Rumbelow! I mean bloody lots.
 *
 */

(function($) {
	
$.fn.tokenInput = function (url, new_token_url, options) {
    var settings = $.extend({
        url: url,
		newTokenUrl: new_token_url,
		autotagUrl: "",
...
$.TokenList = function (input, settings) {
                ...
                case KEY.COMMA:
                  ...
                  if(selected_dropdown_item) {
                    ...
                    return false;
				  	...
				  	if (!$(input_token).children().val() == "") {
						create_token($(input_token));
					}
					return false;
				  }
                  break;
    ...
    function init_list (data) {
        if (!data) { li_data = settings.prePopulate; } else { li_data = data; }
	...
	function create_token(item) {
		var toke = input_token.children().val()
    ...
    function show_dropdown_searching () {
        dropdown
            .html("<p>"+settings.lang.searchingText+"</p>")
            .show();
    }

    function show_dropdown_hint () {
        dropdown
            .html("<p>"+settings.lang.hintText+"</p>")
            .show();
    }
    ...
    function populate_dropdown (query, results) {
        if(results.length) {
            ...
            dropdown
                .html("<p>"+settings.lang.noResultsText+"</p>")
                .show();
        }
    }
