...
class Model extends CI_Model {
	 ...
	 */
	public function Model() { $this->__construct(); }
	...
	/**
	 * Returns an array formatted for form_dropdown().
	 * Takes two arguments, the first the "value", second
	 * the "key". Returns array in this format:
	 *
	 * 		Array [
	 *			$key => $value
	 *		]
	 *
	 * @param string $value Database row to use as value
	 * @param string $key Database row to use as key, by default is the primary key
	 * @return array
	 * @author Phil Sturgeon
	 */
